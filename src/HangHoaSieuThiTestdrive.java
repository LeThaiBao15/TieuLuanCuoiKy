...
public class HangHoaSieuThiTestdrive {
    public static void main(String[] args) {
        ...
        ListHangHoaSieuThi listHangHoa = new ListHangHoaSieuThi();
        int yes;
        ...
        do{
            ...
            switch(lc)
            {
                ...
                HangHoaSieuThi hangHoa = new HangHoaSieuThi(soLuong, ten, loaiHh, gia, ngayNhap);
